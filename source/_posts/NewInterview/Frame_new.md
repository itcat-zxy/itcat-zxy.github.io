---
title: InterView(三) -- 框架篇
tags:
  - frame
  - java
category: Java , frame
keywords: 'Java,frame'
description: 框架相关的面试题
cover: 'https://cdn.staticaly.com/gh/itcat-zxy/Image@main/blog/7p2r6y.66fb0z37jyw0.webp'
abbrlink: new_frame
...
>
>第六步是执行bean的后置处理器BeanPostProcessor，主要是对bean进行增强，有可能在这里产生代理对象
>
>最后一步是销毁bean
>
>### **面试官**：Spring中的循环引用
